...
import { FAKE_USER } from "@/lib/fakeData";
...
// Trimmed version of the real app's sidebar shell - same visual
// language, just fewer nav items (only the pages actually included in
// this preview) and a "back to hub" link instead of a real sign-out flow.
    ...
    <div className="flex h-screen w-full overflow-hidden bg-bg-main">
      <nav className="relative flex w-[64px] shrink-0 flex-col items-center border-r border-white/5 bg-gradient-to-b from-bg-nav via-bg-nav to-bg-panel py-4 sm:w-[90px] sm:py-8">
        ...
        <Link
          ...
          title={`${FAKE_USER.nickname} · Back to ShadowHub`}
        >
          👤
        </Link>
