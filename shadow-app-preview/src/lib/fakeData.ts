// Every value in this file is fabricated for display purposes only. There
// is no database, no auth session, and no network call anywhere in this
// project - this file exists purely so the pages below have something
// fixed to render.
...
export const FAKE_BALANCE = 4250;
...
export const FAKE_DIRECTORY: FakeDirectoryUser[] = [
...
export const FAKE_STREAMS: FakeStream[] = [
